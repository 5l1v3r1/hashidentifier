...
# Copyright (C) 2017 by SMH17 this software is a fork of HashID by c0re.
#
...
__author__  = "SMH17"
__version__ = "1.0.0"
__github__  = "https://github.com/SMH17/hashidentifier"
...
def main():
    ...
    hashID = HashID()
    print("********************************* HashIdentifier 1.0.0 *********************************\nInput an hash and press enter.\nNote: The output results are sorted from most likely hash type to least likely hash type.")
    if not args.outfile:
        outfile = sys.stdout
    else:
        try:
